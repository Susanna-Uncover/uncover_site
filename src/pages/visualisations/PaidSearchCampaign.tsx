          ...
          <div className="mt-10 max-w-3xl">
            ...
            <ul className="space-y-4 text-muted-foreground leading-relaxed">
              <li className="pl-4 border-l-2 border-primary/30">
                <span className="text-primary font-semibold">Overall Profitability:</span> The campaign was overall unprofitable, generating $562K in revenue against $635K in cost, for -$73K profit and a -13.1% net profit margin.
              </li>
              <li className="pl-4 border-l-2 border-primary/30">
                <span className="text-primary font-semibold">ROAS:</span> Closed at 0.88, indicating the campaign did not fully recover its spend.
              </li>
              <li className="pl-4 border-l-2 border-primary/30">
                <span className="text-primary font-semibold">Black Friday:</span> The standout promo type, delivering the strongest efficiency at 4.36 ROAS and a 77.0% net profit margin.
              </li>
              <li className="pl-4 border-l-2 border-primary/30">
                <span className="text-primary font-semibold">Coupon:</span> Delivered the largest conversion volume but also the greatest loss, with 47,170 conversions alongside -$40.72K profit and a -14.9% margin.
              </li>
            </ul>
          </div>
        </div>
