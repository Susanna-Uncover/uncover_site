...
const CodeBlock = ({ children }: { children: string }) => (
  <pre className="bg-secondary/70 border border-border rounded-xl p-4 overflow-x-auto my-4 text-sm leading-relaxed">
...
const Screenshot = ({ src, alt }: { src: string; alt: string }) => (
  <div className="my-6 flex justify-center">
    <img src={src} alt={alt} className="rounded-xl border border-border w-full max-w-2xl" loading="lazy" />
  </div>
);

const SmallScreenshot = ({ src, alt }: { src: string; alt: string }) => (
  <div className="my-6 flex justify-center">
    <img src={src} alt={alt} className="rounded-xl border border-border w-full max-w-sm" loading="lazy" />
  </div>
);

const ParfumoScraping = () => (
  <Layout>
    <article className="section-padding pt-28 max-w-3xl mx-auto min-h-[70vh]">
      <Button variant="ghost" size="sm" asChild className="mb-6">
        <Link to="/portfolio"><ArrowLeft size={16} className="mr-1" /> Back to Portfolio</Link>
      </Button>

      <p className="text-primary text-sm font-medium tracking-widest uppercase mb-2">Python</p>
      <h1 className="font-display text-3xl md:text-4xl font-bold mb-6">
        BeautifulSoup for Web Scraping to Analyse Perfume Trends
      </h1>

      <p className="text-muted-foreground mb-2">The full code is available on GitHub.</p>

      {/* Introduction */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Introduction</h2>
      <p className="mb-4">
      ...
      {/* Pre-requisites */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Pre-requisites</h2>
      ...
      {/* Objectives */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Project objectives</h2>
      <p className="mb-2">Collecting data on the recent perfume releases that have been coming out in the last few years to find out:</p>
      <ul className="list-disc list-inside mb-4 text-muted-foreground space-y-1">
      ...
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">What is Web Scraping?</h2>
      <p className="mb-4">
      ...
      {/* Web Scraping */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Web Scraping</h2>

      <h3 className="font-display text-xl font-semibold mt-8 mb-3">1. Individual page scraping set-up</h3>
      <p className="mb-4">
      ...
      <p className="mb-4">Here is the shortened version of the code, but the full code can be found on GitHub:</p>
...
def scrape_perfume_data(url):
    ...
    return {
      ...
      <h3 className="font-display text-xl font-semibold mt-8 mb-3">2. Collecting URLs of new perfume releases</h3>
      <p className="mb-4">
...
def scrape_all_pages(base_url, total_pages):
    ...
    return all_links`}</CodeBlock>
      ...
      <p className="mb-4">With this in place, I collected all the links and save them as 'perfume_links' as such:</p>
...
print(perfume_links)`}</CodeBlock>
      ...
      <h3 className="font-display text-xl font-semibold mt-8 mb-3">3. Scraping and saving the data</h3>
      <p className="mb-4">
      ...
      <p className="mb-4">So far, the process is looking promising:</p>
...
print("Data saved to:", csv_file)`}</CodeBlock>
      ...
      <p className="mb-4">And here is the final data frame that I have scraped:</p>

      <Screenshot src={dataFrame} alt="Final scraped data frame with perfume details" />

      <h3 className="font-display text-xl font-semibold mt-8 mb-3">4. Cleaning the perfume notes columns</h3>
      <p className="mb-4">
...
print(top_ingredient_series_cleaned)`}</CodeBlock>
      ...
      <p className="mb-4">And here is the final result. The same process was repeated for heart and base notes as well to collect these ingredients:</p>

      <Screenshot src={ingredientCounts} alt="Cleaned ingredient counts series" />

      {/* Data Analysis */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Data Analysis</h2>
      <p className="mb-4">
      ...
      <h3 className="font-display text-xl font-semibold mt-8 mb-3">Top 5 ingredients featured in Top Notes most often (n=330)</h3>
      ...
      <h3 className="font-display text-xl font-semibold mt-8 mb-3">Top 5 ingredients featured in Heart Notes most often (n=420)</h3>
      ...
      <h3 className="font-display text-xl font-semibold mt-8 mb-3">Top 5 ingredients featured in Base Notes most often (n=262)</h3>
      ...
      {/* Key Takeaways */}
      <h2 className="font-display text-2xl font-semibold mt-10 mb-3">Key Takeaways</h2>
      <ul className="list-disc list-inside mb-10 text-muted-foreground space-y-2">
        <li>Ethical scraping is essential. Limiting requests and respecting website content ensured responsible data collection without overloading the source.</li>
        <li>Raw data requires significant cleaning. Scraped ingredient lists contained duplicates, punctuation errors, and inconsistent formatting that required consolidation before analysis.</li>
        <li>Vanilla's popularity is confirmed. Ranking third overall behind musk and bergamot, vanilla's prominence in recent releases validates the perfume community's observations about its growing trend.</li>
      </ul>
    </article>
  </Layout>
);
